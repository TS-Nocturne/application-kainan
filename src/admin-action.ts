export type AdminAction = 'interview' | 'skip' | 'approve' | 'reject';
...
const ADMIN_ACTION_ID =
  /^registration:(interview|skip|approve|reject):([0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12})$/i;
